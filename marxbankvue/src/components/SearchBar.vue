<template>
    <div className="search">
        <div className="searchInputs">
            <input @input="onInput" ref="inputField" type="text" :placeholder="placeholder" className="input"/>
        </div>
        <div className="dataResult">
            <div v-for="account in data" :key="account.id"
                className="dataItem" @click="onSelectAccount(account)">
        ...
        <div class="textbox">
            ...
            <p v-if="!reciever" class="float-right">{{ selectedAccount.balance }} kr</p>
